...
<body id="body-main">
  <div id="beta" class="clear">*** BETA - Version 2.1 - All bugs to be reported to webmaster ***</div>
        <div id="container">
          <div id="quick" />
            ...
            <a href="patient_controller/logout" class="" title="Logout">Logout</a>
          </div>
          <div id="menu" />
          	<a href="http://localhost/dispenser" class="logo"></a>
            <ul>
